...
import { Book, CheckCircle, Clock, ThumbsUp, ArrowRight } from "lucide-react"
                ...
                <div className="flex-1 min-w-0 ml-3">
                    ...
                    <div className="flex items-center justify-between mt-2">
                        ...
                        {request.status === "approved" && (
                            <Link href={`/search?q=${encodeURIComponent(request.title)}`} className="flex items-center gap-1 px-3 h-8 text-white uppercase text-xs font-semibold rounded-full border border-gray-200 bg-blue-600">
                                <span>Get</span>
...
// import { zodResolver } from "@hookform/resolvers/zod"
// import * as z from "zod"
// import { ArrowRight, Book, CheckCircle, Clock, Download, ThumbsUp } from "lucide-react"
// import { useSearchParams } from "next/navigation"
// import { Button } from "@/components/ui/button"
// import { Card, CardContent } from "@/components/ui/card"
// import { Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage } from "@/components/ui/form"
...
//                         {request.status === "approved" && (
//                             <Link href={`/search/?title=${request.title}`} className="flex items-center gap-1 px-3 h-8 text-white uppercase text-xs font-semibold rounded-full border border-gray-200 bg-blue-600">
//                                 <span>Get</span>
//                                 <ArrowRight className="h-4 w-4 ml-1" />
//                             </Link>
//                         )}
