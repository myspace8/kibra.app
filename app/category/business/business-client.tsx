...
import { ChevronLeft, Search, FolderOpen } from "lucide-react"
      ...
      <main className="space-y-8">
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold">Popular Business Books</h2>
          </div>
          {success && books && books.length > 0 ? (
            ...
            <p className="text-center text-muted-foreground">
              {error || "No business books available."}
            </p>
          )}
        </section>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold">Business Collections</h2>
          </div>
