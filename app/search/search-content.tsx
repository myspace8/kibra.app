...
import { ChevronLeft, Search, X, MoreHorizontal, Book, BookPlus } from "lucide-react"
      ...
      <main className="space-y-6 mt-6 min-h-[70vh]">
        ...
        {recentSearches.length > 0 && (
          <section className="space-y-2">
            ...
            <div className="flex flex-col overflow-x-auto gap-2 pb-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
              {visibleSearches.map((search) => (
                <div
                  key={search}
                  className="flex items-center justify-between gap-1 px-3 py-2 bg-gray-100 rounded-full text-sm text-gray-700 hover:bg-gray-200 transition-colors whitespace-nowrap"
                >
                  <button
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!(query === search && books.length > 0) && (
                      <Button
                        ...
                        className="h-5 w-5 text-white hover:text-primary"
                      >
