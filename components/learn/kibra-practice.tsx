...
interface Exam {
  ...
  topics: string[];
  created_at: string; // ISO date string or Date object, depending on your data source
                ...
                <div className="flex flex-col gap-3">
                  {suggestedExams.map((exam, index) => (
                    <ExamCard
                      ...
                      exam={{
                        ...exam,
                        created_at: typeof exam.created_at === "string" ? new Date(exam.created_at) : exam.created_at,
                      }}
                      ...
                      separator={index < suggestedExams.length - 1}
